...
const userSchema = new mongoose.Schema(
  {
    ...
    // مفعّل بس على حساب المدرس نفسه (مش الطلاب) — علم مؤقت يقدر المدرس
    // يشغّله/يوقفه بنفسه من صفحة "حسابي". طول ما هو مفعّل، فحص "جهاز واحد
    // للطالب" في auth.controller.js بيتوقف مؤقتًا (بيسجّل آخر جهاز دخل بيه
    // الطالب بدل ما يرفضه) — مفيد وقت ما كل الطلاب بينتقلوا لاستخدام تطبيق
    // الأندرويد (APK) وهو سياق تخزين مختلف عن كروم/PWA. لا علاقة له بـ
    // resetDevice اليدوي، اللي بيفضل شغال في كل الأحوال.
    deviceTransitionMode: {
      type:    Boolean,
      default: false,
    },
